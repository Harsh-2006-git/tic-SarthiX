...
import { Bot, FileText, Sparkles, Send, Calendar, MapPin as MapPinIcon, ArrowRight, Star } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] border border-orange-50/50 rounded-full animate-orbit pointer-events-none opacity-40" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] border border-orange-100/30 rounded-full animate-orbit-reverse pointer-events-none opacity-30" />
      </div>

      <main className="flex-1 container mx-auto px-4 sm:px-8 lg:px-12 pt-32 pb-20 relative z-10">
        <div className="flex flex-col lg:flex-row gap-10">

          {/* Left Column: Hero & Interactive Cards */}
          <div className="w-full lg:w-[400px] flex flex-col gap-8 animate-fade-in-up">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium text-lg leading-relaxed">
                Let our sacred intelligence craft an auspicious itinerary for your Ujjain pilgrimage.
              </p>
            </div>
              ...
              <Dialog open={isChatOpen} onOpenChange={setIsChatOpen}>
                <DialogTrigger asChild>
                  <div className="group relative cursor-pointer overflow-hidden rounded-[2rem] bg-white p-1 shadow-xl transition-all hover:shadow-2xl hover:-translate-y-1 active:scale-95">
                    ...
                    <div className="relative flex flex-col items-center justify-center rounded-[1.8rem] bg-white p-8 text-center transition-colors group-hover:bg-white/95 h-full">
          ...
          <div className="flex-1 min-h-[600px] flex flex-col animate-fade-in-up delay-[200ms]">
            <div className="flex-1 bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto itinerary-scrollbar p-8 bg-slate-50/30">
                <ItineraryDisplay
                  itinerary={itinerary}
                  isLoading={isLoading}
                  error={error}
