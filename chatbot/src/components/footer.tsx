                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="md:col-span-5 space-y-8 flex flex-col items-center md:items-start text-center md:text-left">
                        <div className="group cursor-pointer">
                            <Link href="http://localhost:5173" className="flex items-center gap-3 text-3xl font-black italic tracking-tighter transition-all duration-300 group-hover:scale-105">
                    ...
                    <div className="hidden md:block md:col-span-3 lg:px-12 border-l border-white/5">
                        ...
                        <ul className="space-y-4">
                            {[
                                { label: "Live Darshan", path: "http://localhost:5173/live-darshan" },
                                { label: "Ticket Booking", path: "http://localhost:5173/ticket" },
                                { label: "Zone Status", path: "http://localhost:5173/dencity" },
                                { label: "Lost & Found", path: "http://localhost:5173/lostFound" },
                                { label: "Interactive Map", path: "http://localhost:5173/map" },
                                { label: "City Guide", path: "http://localhost:5173/#about" }
                            ].map((link) => (
                                <li key={link.label}>
                                    <Link
                                        href={link.path}
